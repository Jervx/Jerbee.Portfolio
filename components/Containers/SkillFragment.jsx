...
const SkillFragment = ({
  ...
  return blank ? (
    ...
    <div
      className={`relative  ${className} group hover:translate-x-2 hover:-translate-y-2 hover:scale-[1.055] duration-150 ease-out cursor-pointer`}
    >
      <div
      ...
      >
        ...
        <p
          className={`bottom-1 absolute w-3/4 ml-[1vh] text-sm font-semibold text-center z-30 font-inter px-3 py-0 rounded-full scale-0 group-hover:scale-105 duration-300 ease-in-out ${titleClassName} ${mainBg}`}
